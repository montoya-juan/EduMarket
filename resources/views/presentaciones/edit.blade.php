...
@section('content')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="{{ route('presentaciones.index') }}">Presentaciones</a>
        ...
        <form action="{{ route('presentaciones.update',['presentacione'=>$presentacione]) }}" method="post">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" value="{{old('nombre',$presentacione->caracteristica)}}" required>
                    @error('nombre')
